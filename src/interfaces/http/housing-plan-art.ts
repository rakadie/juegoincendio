...
export function renderHousingPlanDefs(): string {
  return `<defs>
    ...
    <style>
      ...
      .housing-plan .housing-risk-zone { fill: #c47a32; fill-opacity: .22; stroke: #ffe0a8; stroke-width: 3; stroke-dasharray: 9 7; }
      .housing-plan .housing-risk-detail { fill: none; stroke: #fff1ce; stroke-width: 3; stroke-linecap: round; filter: drop-shadow(0 1px 1px #513219); }
      .housing-plan #housing-vertical-fuel .housing-clearance { display: none; fill: url(#housing-treated-ground); stroke: #e9f1db; stroke-width: 3; stroke-dasharray: 8 6; opacity: .72; }
      .housing-plan #housing-vertical-fuel .housing-cut-marks { display: none; fill: none; stroke: #496c57; stroke-width: 3; stroke-linecap: round; }
      ...
      .housing-plan #housing-canopy .housing-canopy-crown { fill: none; stroke: #ffe4ae; stroke-width: 3; stroke-dasharray: 10 7; filter: drop-shadow(0 1px 1px #274433); }
      .housing-plan #housing-canopy .housing-canopy-link { fill: none; stroke: #c87831; stroke-width: 24; stroke-linecap: round; opacity: .52; }
      .housing-plan #housing-canopy .housing-canopy-link-detail { fill: none; stroke: #fff1c9; stroke-width: 3; stroke-dasharray: 9 7; }
      .housing-plan #housing-canopy.state-broken .housing-canopy-crown { stroke: #dcedd7; }
      .housing-plan #housing-canopy.state-broken .housing-canopy-gap { fill: url(#housing-treated-ground); stroke: #f3f7e8; stroke-width: 3; stroke-dasharray: 7 6; opacity: .76; }
      .housing-plan #housing-canopy.state-broken .housing-gap-mark { fill: none; stroke: #3f7359; stroke-width: 4; stroke-linecap: round; }
      .housing-plan #housing-local-access .housing-access-risk { fill: none; stroke: #c87831; stroke-width: 54; stroke-linecap: round; opacity: .38; }
      .housing-plan #housing-local-access .housing-access-centre { fill: none; stroke: #fff0c6; stroke-width: 3; stroke-linecap: round; stroke-dasharray: 9 8; }
      .housing-plan #housing-local-access .housing-clear-route { display: none; fill: none; stroke: #dcebd6; stroke-width: 37; stroke-linecap: round; opacity: .58; }
      .housing-plan #housing-local-access .housing-clear-route-line { display: none; fill: none; stroke: #356b53; stroke-width: 4; stroke-linecap: round; stroke-dasharray: 11 8; }
      ...
      .housing-plan .housing-condition-ring { fill: #c07832; fill-opacity: .08; stroke: #ffe1ac; stroke-width: 3; stroke-dasharray: 10 8; }
...
export function renderHousingPlanBase(): string {
  return `<g class="housing-base" aria-hidden="true">
    ...
    <g transform="translate(681 24)">
      <rect class="housing-scene-caption" width="195" height="34" rx="9" />
      <text class="housing-scene-note" x="98" y="22" text-anchor="middle">Vista educativa · sin escala</text>
    </g>
  </g>`;
}
