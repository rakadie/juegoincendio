...
#27 podrá validar el grafo completo como estructura declarativa: unicidad de IDs, alcanzabilidad desde el inicio, ausencia de ciclos, convergencias permitidas y correspondencia entre predicados y destinos.
